...
export const LUSCII_NARRATIVE: ProductNarrative = {
  ...
  regulatory_position: {
    device_class: 'Medical device — Class I transitional (HIRA-evidenced)',
  ...
  assurance_domains: [
    ...
    { domain: 'Medical device regulation', status: 'verified_current', summary: 'HIRA evidence pack complete; documented classification rationale; pathway to Class IIa-equivalent assurance', verified_date: '2024-06' },
  ...
  commercial_readiness: {
    ...
    price_summary: 'From £110 per patient per year (hub model, indicative)',
