          ...
          >
            <span className="relative block aspect-video w-full bg-black">
              ...
              <span
                ...
                aria-hidden
              >
                <span className="flex h-14 w-14 items-center justify-center rounded-full bg-white/95 shadow-md" style={{ color: '#c00' }}>
                  <Play className="ml-0.5 h-8 w-8" strokeWidth={2.2} aria-hidden />
                </span>
              </span>
            </span>
