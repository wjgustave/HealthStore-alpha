...
const NAV_ITEMS = [
  ...
  { href: '/about', label: 'How it works', match: (p: string) => p.startsWith('/about') },
  { href: '/resources', label: 'Guidance', match: (p: string) => p.startsWith('/resources') },
]
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '16px 24px', display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap' }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 16, textDecoration: 'none' }}>
            ...
            <div style={{ borderLeft: '1px solid #d8dde0', paddingLeft: 16 }}>
              <span style={{ fontSize: 20, fontWeight: 600, color: '#212b32', display: 'block' }}>NHS Commissioning Store</span>
