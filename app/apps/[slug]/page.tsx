    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="p-8">
          <div className="flex flex-col md:flex-row gap-6 items-start justify-between">
            <div className="flex-1">
              ...
              <p style={{ fontSize: '0.95rem', color: 'var(--text-muted)', marginBottom: '1rem' }}>{app.supplier_name}</p>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-8">
          ...
          {/* Clinical evidence — detailed */}
          <section className="bg-white rounded-xl border p-6" style={{ borderColor: 'var(--border)' }}>
            <SectionHeader
              title="Clinical evidence"
              description="Full evidence record from the HTE19 dossier. Links to source publications provided where available."
            />
            ...
            {/* NICE assessments, grey lit, implementation science */}
            ...
            {/* Fallback if no detailed evidence */}
          ...
          <section className="bg-white rounded-xl border p-6" style={{ borderColor: 'var(--border)' }}>
            ...
            <dl className="divide-y" style={{ borderColor: 'var(--border)' }}>
              ...
              <Row label="Procurement routes" value={app.contract_note} />
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>
                  ...
                  {app.live_sites && ` · ${app.live_sites.split(',')[0].trim()}`}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border overflow-hidden" style={{ borderColor: accent }}>
            ...
            <div style={{ background: accent, padding: '16px 18px' }}>
              ...
              <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.85)', lineHeight: 1.5, margin: '0 0 12px' }}>
                Contact {app.supplier_contact_name ?? app.supplier_name} to discuss deployment in your ICB, request a demonstration, or ask about evidence generation requirements.
              </p>
              <a href={`mailto:${app.supplier_contact_email ?? app.contact_email}?subject=Interest in ${app.app_name} — NICE HTE19 COPD&body=Hello,%0D%0A%0D%0AI am writing to express interest in deploying ${app.app_name} within our ICB as part of the NICE HTE19 COPD digital therapeutics programme.%0D%0A%0D%0AOrganisation:%0D%0ARole:%0D%0APopulation size (approx):%0D%0AKey questions:%0D%0A%0D%0AThank you`}
                style={{
